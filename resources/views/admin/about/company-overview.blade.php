<div class="collapse show py-3 px-3 rounded bg-neutral" id="collapseCompanyOverview" aria-labelledby="headingCompanyOverview" data-parent="#accordionAbout">
    <form class="text-sm" action="{{ route('save.company-overview') }}" method="POST" class="php-email-form" enctype="multipart/form-data">
        ...
        <button type="submit" class="btn btn-block btn-primary">Update Company Overview</button>
    </form>
</div>
