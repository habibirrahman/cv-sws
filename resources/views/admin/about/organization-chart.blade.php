<div class="collapse py-3 px-3 rounded bg-neutral" id="collapseOrganizationChart" aria-labelledby="headingOrganizationChart" data-parent="#accordionAbout">
    <form class="text-sm" action="{{ route('save.organization-chart') }}" method="POST" class="php-email-form" enctype="multipart/form-data">
        ...
        <button type="submit" class="btn btn-block btn-primary">Update Organization Chart</button>
    </form>
</div>
