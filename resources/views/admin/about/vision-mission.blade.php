<div class="collapse rounded card" id="collapseVisionMission" aria-labelledby="headingVisionMission" data-parent="#accordionAbout">
    <div class="card-header">
        <h4>
            <i class="fas fa-id-card"></i>
            <span class="ml-2">Vision Mission</span>
        </h4>
    </div>
    <div class="card-body">
        <form class="text-sm" action="{{ route('save.vision-mission') }}" method="POST" class="php-email-form" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn btn-block btn-primary">Save Vision Mission</button>
        </form>
    </div>
</div>
