<div class="collapse rounded card" id="collapseCompanyCapability" aria-labelledby="headingCompanyCapability" data-parent="#accordionHome">
    <div class="card-header">
        <h4>
            <i class="fas fa-home"></i>
            <span class="ml-2">Company Capability</span>
        </h4>
    </div>
    <div class="card-body">
        <form class="text-sm" action="{{ route('save.company-capability') }}" method="POST" class="php-email-form" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn btn-block btn-primary">Save Company Capability</button>
        </form>
    </div>
</div>
