<div class="collapse py-3 px-3 rounded bg-neutral" id="collapseContactUs" aria-labelledby="headingContactUs" data-parent="#accordionHome">
    <form class="text-sm" action="{{ route('save.contact-us') }}" method="POST" class="php-email-form" enctype="multipart/form-data">
        ...
        <button type="submit" class="btn btn-block btn-primary">Update Contact</button>
    </form>
</div>
