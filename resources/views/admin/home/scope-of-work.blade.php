<div class="collapse rounded card" id="collapseScope" aria-labelledby="headingScopeOfWork" data-parent="#accordionHome">
    <div class="card-header">
        <h4>
            <i class="fas fa-home"></i>
            <span class="ml-2">Scope of Work</span>
        </h4>
    </div>
    <div class="card-body">
        <form class="text-sm" action="{{ route('save.scope-of-work') }}" method="POST" class="php-email-form" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn btn-block btn-primary">Save Scope of Work</button>
        </form>
    </div>
</div>
