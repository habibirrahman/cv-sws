<footer id="ts-footer">
  ...
  <!--end map-->
  <section id="contact" class="ts-block ts-background-is-dark ts-separate-bg-element" data-bg-image="{{ asset('assets/img/bg-1920x1400.jpg') }}" data-bg-image-opacity=".1" data-bg-color="#1f1f1f" data-mask-bottom-wn-color="#891231">
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          <h3>Contact Us</h3>
