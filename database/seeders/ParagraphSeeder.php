...
class ParagraphSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $paragraphs = [
            ...
            ['address-1', 'Jl. Sumber Waras I 11 RT.05 RW.08'],
            ['address-2', 'Kelurahan Kalirejo, Kecamatan Lawang'],
            ['address-3', 'Kabupaten Malang, Provinsi Jawa Timur'],
            ['address-4', ''],
            ['address-5', ''],
            ['email-1', 'sumberwaras011@gmail.com'],
            ['email-2', ''],
            ['email-3', ''],
            ['phone-1', '(0341) 430 94 25'],
            ['phone-2', '(+62) 81 233 200 918 (Malang)'],
            ['phone-3', '(+62) 82 134 613 708 (Other)'],
            ['phone-4', ''],
            ['phone-5', ''],
