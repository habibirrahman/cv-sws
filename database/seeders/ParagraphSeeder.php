...
class ParagraphSeeder extends Seeder
{
    ...
    public function run()
    {
        $paragraphs = [
            ...
            ['identifier' => 'profile-text-3', 'text' => ''],
            ['identifier' => 'profile-text-4', 'text' => ''],
            ...
            ['identifier' => 'company-overview-text-5', 'text' => ''],
            ['identifier' => 'company-overview-text-6', 'text' => ''],
            ...
            ['identifier' => 'organization-chart-text-1', 'text' => ''],
            ['identifier' => 'organization-chart-text-2', 'text' => ''],
            ['identifier' => 'organization-chart-text-3', 'text' => ''],
            ['identifier' => 'organization-chart-text-4', 'text' => ''],
        ];
